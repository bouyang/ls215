...
const dishName = [];
dishName.push(random(adjective));
dishName.push(random(firstNoun));
dishName.push(random(secondNoun));

const dish = [];
dish.push(random(ingredients, 3));
dish.push(random(spices, 2));
dish.push(random(extras, 1));
